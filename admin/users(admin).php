        ...
        <div class="signup">
            <div class="signup-cont">
                ...
                <div class="prod-cont">
                    ...
                    echo"<table class='table1'><tr id='tr1' ><td>ID</td> <td>Username</td> <td>Email</td> <td>Password</td></tr>";
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                        echo"<tr><td class='td1' id='td1'>$row[0]</td>
                         ...
                         <td class='td1'> <a class='btn ' href='./user management(admin).php?id=$row[0]'>EDIT</a></td></tr>";
                    }
