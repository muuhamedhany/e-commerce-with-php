                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                src="../IMG/oneplus12.jpg" alt="oneplus12">
                            </td>

                            <td class="p">
                                <p class="p1">OnePlus 12</p>
                                <br>
                                <p class="p2"> About this item

                                    <ul>
                                        <li>
                                            Comes with 6 months of Google One and 3 months of Youtube Premium with purchase of OnePlus 12. (New accounts only for each service to qualify) 
                                        </li>
                                        <li>
                                            Pure Performance: The OnePlus 12 is powered by the latest Snapdragon 8 Gen 3, with up to 16GB of RAM.
                                        </li>
                                        <li>
                                            Brilliant Display: The OnePlus 12 has a stunning 2k 120Hz Super Fluid Display, with advanced LTPO for a brighter, smoother, and more vibrant viewing experience
                                        </li>
                                        <li>
                                            Powered by Trinity Engine: The OnePlus 12's performance is optimized by the Trinity Engine, which accelerates various softwares to maximize the performance of your device.
                                        </li>
                                    </ul>
...
if (isset($_GET['add'])) 
{
    $stmt1 = "SELECT * FROM `product` WHERE `ProductID` = '7'";
    ...
    if ($result_cartitem == TRUE) 
    {
        ...
        $stmt4 = "UPDATE `product` SET `Quantity` = `Quantity` - $quantity WHERE `ProductID` = '7'";
        mysqli_query($conn, $stmt4);

        header("Location: ./onepus12.php");
        exit();
    }
}

$stmt3 = "SELECT `Quantity` FROM `product` WHERE `ProductID` = '7' AND `Quantity` > 0";
