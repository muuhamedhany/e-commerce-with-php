                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                src="../IMG/iphone15.jpg" alt="iphone15">
                            </td>

                            <td class="p">
                                <p class="p1">Apple iPhone 15</p>
                                <br>
                                <p class="p2">
                                    About this item
                                    ...
                                    <ul>
                                        <li>
                                            6.7inch Super Retina XDR display. ProMotion technology. Always-On display. Titanium with textured matte glass back.
                                        </li>
                                        <li>
...
if (isset($_GET['add'])) 
{
    $stmt1 = "SELECT * FROM `product` WHERE `ProductID` = '3'";
    ...
    if ($result_cartitem == TRUE) 
    {
        ...
        $stmt4 = "UPDATE `product` SET `Quantity` = `Quantity` - $quantity WHERE `ProductID` = '3'";
        mysqli_query($conn, $stmt4);

        header("Location: ./iph15.php");
        exit();
    }
}

$stmt3 = "SELECT `Quantity` FROM `product` WHERE `ProductID` = '3' AND `Quantity` > 0";
