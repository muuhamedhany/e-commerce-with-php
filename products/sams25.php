                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                src="../IMG/samA25.jpg" alt="samS25">
                            </td>

                            <td class="p">
                                <p class="p1">SAMSUNG Galaxy S25</p>
                                <br>
                                <p class="p2"> About this item

                                    <ul>
                                        <li>
                                            YOUR CONTENT, SUPERSMOOTH: Whether watching shows, playing games or reading online 
                                        </li>
                                        <li>
                                            CAPTURE AWE-WORTHY CONTENT: Mountain ranges, sunsets, dinners with friends — do the moment justice with the high-resolution cameras of Galaxy A25 5G
                                        </li>
                                        <li>
                                            MSTORE MORE & WORRY LESS: With improved internal storage of up to 128GB and up to 1TB² of expandable storage
                                        </li>
                                        <li>
                                            STEREO SPEAKERS: Experience sensational sound at your fingertips with Galaxy A25 5G; All new stereo speakers get you fully into the world of your favorite music
                                        </li>
                                    </ul>
...
if (isset($_GET['add'])) 
{
    $stmt1 = "SELECT * FROM `product` WHERE `ProductID` = '4'";
    ...
    if ($result_cartitem == TRUE) 
    {
        ...
        $stmt4 = "UPDATE `product` SET `Quantity` = `Quantity` - $quantity WHERE `ProductID` = '4'";
        mysqli_query($conn, $stmt4);

        header("Location: ./sams25.php");
        exit();
    }
}

$stmt3 = "SELECT `Quantity` FROM `product` WHERE `ProductID` = '4' AND `Quantity` > 0";
