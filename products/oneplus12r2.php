                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                src="../IMG/1plus12R2.jpg" alt="oneplus12r2">
                            </td>

                            <td class="p">
                                <p class="p1">OnePlus 12r2</p>
                                <br>
...
if (isset($_GET['add'])) 
{
    $stmt1 = "SELECT * FROM `product` WHERE `ProductID` = '9'";
    ...
    if ($result_cartitem == TRUE) 
    {
        ...
        $stmt4 = "UPDATE `product` SET `Quantity` = `Quantity` - $quantity WHERE `ProductID` = '9'";
        mysqli_query($conn, $stmt4);

        header("Location: ./oneplus12r2.php");
        exit();
    }
}

$stmt3 = "SELECT `Quantity` FROM `product` WHERE `ProductID` = '9' AND `Quantity` > 0";
