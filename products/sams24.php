                                ...
                                <tr>
                                    <td>
                                        <img style="width: 220px; padding: 30px; padding-right: 0px;"
                                            src="../IMG/samS24.jpg" alt="samS15">
                                    </td>

                                    <td class="p">
                                        <p class="p1">Samsung Galaxy S24</p>
                                        <br>
                                        <p class="p2">
                                            About this item
                                        ...
                                        <ul>
                                            <li>
                                                CIRCLE & SEARCH¹ IN A SNAP: Circle to Search1 with Google to get the answer
                                            </li>
                                            <li>
                                                REAL EASY, REAL-TIME TRANSLATIONS: Speak foreign languages on the spot with Live Translate²
                                            </li>
                                            <li>
                                                NOTE SMARTER, NOT HARDER: Focus on capturing your notes and spend less time perfecting them
                                            </li>
                                            <li>
                                                MORE WOW, LESS WORK: Turn every photo into a post-worthy masterpiece; Move or remove objects
                                            </li>
                                        </ul>
...
if (isset($_GET['add'])) 
{
    $stmt1 = "SELECT * FROM `product` WHERE `ProductID` = '6'";
    ...
    if ($result_cartitem == TRUE) 
    {
        ...
        $stmt4 = "UPDATE `product` SET `Quantity` = `Quantity` - $quantity WHERE `ProductID` = '6'";
        mysqli_query($conn, $stmt4);

        header("Location: ./sams24.php");
        exit();
    }
}

$stmt3 = "SELECT `Quantity` FROM `product` WHERE `ProductID` = '6' AND `Quantity` > 0";
